window.TrustWallet={account:null,signer:null,provider:null,
 ...
 disconnect(){this.account=null;this.signer=null;this.provider=null;sessionStorage.setItem("trustticket_wallet_disconnected","true");this.update();window.showToast?.("Wallet disconnected from TrustTicket.")},
