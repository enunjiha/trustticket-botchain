window.TrustWallet={account:null,signer:null,provider:null,
 ...
 async restore(){if(!window.ethereum)return;const a=await ethereum.request({method:"eth_accounts"});if(a[0]){this.provider=window.ethereum;this.signer=null;this.account=a[0];this.update();this.routeByRole()}},
